...
for res = 1:1
    ...
    for i = 1:4
        ...
        hold on
        if(i==1)
            plot_global_map(lats, lons, Albedo_abs_difference, min_values(2), max_values(2),"", colors_2,1, 0);
        else
            plot_global_map(lats, lons, Albedo_abs_difference, min_values(2), max_values(2),"", colors_2,0, 0);
        end
    ...
    print(gcf, '-dpng', '-r300', '../figure_submitted/fig03.png')
