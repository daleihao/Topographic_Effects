...
for res = 1:1
    ...
    for i = 1:4
        ...
        hold on
        if(i==1)
            plot_global_map(lats, lons, Albedo_PP, min_values(1), max_values(1),"", colors,1, 0);
        else
            plot_global_map(lats, lons, Albedo_PP, min_values(1), max_values(1),"", colors,0, 0);
        end
        ...
        hold on
        if(i==1)
            plot_global_map(lats, lons, Albedo_PP, min_values(1), max_values(1),"", colors,1, 1);
        else
            plot_global_map(lats, lons, Albedo_PP, min_values(1), max_values(1),"", colors,0, 1);
        end
    ...
    print(gcf, '-dsvg', '-r300', '../revised_figures/figure4_comparisons_all_variables.svg')
