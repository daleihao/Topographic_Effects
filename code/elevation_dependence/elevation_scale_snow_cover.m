...
for res = 1:5    
   ...
   save(['snow_cover_' scale '.mat' ],'group_data');
end
...
for res = 1:5    
  ...
  Albedo_PP = mean_10_year_ELM_notop_FIRE_all;
   ...
   % boxplot(group_data(:,2),group_data(:,1))
   save(['temperature_' scale '.mat' ],'group_data');
end
...
for res = 1:5    
   ...
   % boxplot(group_data(:,2),group_data(:,1))
   save(['net_solar_radiation_' scale '.mat' ],'group_data');
end
...
for res = 1:5    
   ...
   % boxplot(group_data(:,2),group_data(:,1))
   save(['latent_heat_flux_' scale '.mat' ],'group_data');
end
...
for res = 1:5    
   ...
   % boxplot(group_data(:,2),group_data(:,1))
   save(['sensible_heat_flux_' scale '.mat' ],'group_data');
end
