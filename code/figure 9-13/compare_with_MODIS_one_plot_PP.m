...
for res = 1:1
    ...
    %% WSA
        ...
        hold on
        if(i==1)
            plot_global_map(lats, lons, BSA_notop_difference, -0.2, 0.2,"", colors, 1, 0);
        else
            plot_global_map(lats, lons, BSA_notop_difference, -0.2, 0.2,"", colors, 0, 0);
        end
        if(i==1)
    ...
    %% surface temperature        
        ...
        hold on
        if(i==1)
            plot_global_map(lats, lons, BSA_notop_difference, -10, 10,"", colors, 1, 0);
        else
            plot_global_map(lats, lons, BSA_notop_difference, -10, 10,"", colors, 0, 0);
        end
        if(i==1)
     ...
     %% surface temperature
       load(['../../data/10year_average/' scale '_' SeasonsNames{i} '_alldata.mat']);
        ...
        hold on
        if(i==1)
            plot_global_map(lats, lons, BSA_notop_difference, -30, 30,"", colors, 1, 1);
        else
            plot_global_map(lats, lons, BSA_notop_difference, -30, 30,"", colors, 0, 1);
        end
        if(i==1)
    ...
    print(gcf, '-dsvg', '-r300', '../revised_figures/figure_10_MODIS_PP.svg')
    close all
end
