...
for res = 1:1
    ...
    for i = 1:4
        ...
        load(['../../writting/topographic effects/plot_figures/data/10year_average/'  scale '_' SeasonsNames{i} '_alldata.mat']);
        ...
        difference = top_derived - notop_derived;
         ...
         difference = difference./albedo_notop;
    ...
    print(gcf, '-dtiff', '-r600', 'results/importance_albedo.png')
    ...
    for i = 1:4
        ...
        load(['../../writting/topographic effects/plot_figures/data/10year_average/'  scale '_' SeasonsNames{i} '_alldata.mat']);
        top_derived = mean_10_year_ELM_top_LH_all;
        notop_derived = mean_10_year_ELM_notop_LH_all;
    ...
    print(gcf, '-dtiff', '-r600', 'results/importance_latent_heat_flux.png')
    ...
    for i = 1:4
        ...
        load(['../../writting/topographic effects/plot_figures/data/10year_average/'  scale '_' SeasonsNames{i} '_alldata.mat']);
        top_derived = mean_10_year_ELM_top_netradiation_all;
        notop_derived = mean_10_year_ELM_notop_netradiation_all;
    ...
    print(gcf, '-dtiff', '-r600', 'results/importance_net_solar_radiation.png');
    ...
    for i = 1:4
        ...
        load(['../../writting/topographic effects/plot_figures/data/10year_average/'  scale '_' SeasonsNames{i} '_alldata.mat']);
        top_derived = mean_10_year_ELM_top_SNOWDP_average_all;
        notop_derived = mean_10_year_ELM_notop_SNOWDP_average_all;
    ...
    print(gcf, '-dtiff', '-r600', 'results/importance_snow_depth.png')
    ...
    for i = 1:4
        ...
        load(['../../writting/topographic effects/plot_figures/data/10year_average/'  scale '_' SeasonsNames{i} '_alldata.mat']);
        top_derived = mean_10_year_ELM_top_FSH_all;
        notop_derived = mean_10_year_ELM_notop_FSH_all;
    ...
    print(gcf, '-dtiff', '-r600', 'results/importance_sensible_heat_flux.png')
