...
for res = 1:5
    ...
    for i = 1:1
        ...
        switch res
            case 1
                scale_1_all = Albedo_rel_difference(mean_slope>0);
            case 2
                scale_2_all = Albedo_rel_difference(mean_slope>0);
            case 3
                scale_3_all = Albedo_rel_difference(mean_slope>0);
            case 4
                scale_4_all = Albedo_rel_difference(mean_slope>0);
            case 5
                scale_5_all = Albedo_rel_difference(mean_slope>0);
        end
...
print(gcf, '-dsvg', '-r300', '../improved_figures/figure_17_scale_albedo.svg')
close all
