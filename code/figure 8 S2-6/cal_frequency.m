...
figure;
hold on
[f_tmp,y_tmp] = histcounts(scale_1_all(:), 120,'BinLimits',[-0.3 0.3],'Normalization','probability');
y_tmp = (y_tmp(1:(end-1))+0.005)*100;
yyaxis right
plot(y_tmp,f_tmp*100, 'r-','LineWidth',0.8)

[f_tmp,y_tmp] = histcounts(scale_2_all(:), 120,'BinLimits',[-0.3 0.3],'Normalization','probability');
y_tmp = (y_tmp(1:(end-1))+0.005)*100;
yyaxis right
plot(y_tmp,f_tmp*100, 'y-','LineWidth',0.8)
[f_tmp,y_tmp] = histcounts(scale_3_all(:), 120,'BinLimits',[-0.3 0.3],'Normalization','probability');
y_tmp = (y_tmp(1:(end-1))+0.005)*100;
yyaxis right
plot(y_tmp,f_tmp*100, 'c-','LineWidth',0.8)
[f_tmp,y_tmp] = histcounts(scale_4_all(:), 120,'BinLimits',[-0.3 0.3],'Normalization','probability');
y_tmp = (y_tmp(1:(end-1))+0.005)*100;
yyaxis right
plot(y_tmp,f_tmp*100, 'b-','LineWidth',0.8)
[f_tmp,y_tmp] = histcounts(scale_5_all(:), 120,'BinLimits',[-0.3 0.3],'Normalization','probability');
y_tmp = (y_tmp(1:(end-1))+0.005)*100;
yyaxis right
